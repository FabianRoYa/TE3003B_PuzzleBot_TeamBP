...
setup(
    name=package_name,
    author='Fabian Erubiel Rojas Yañez\nJose Antonio Miranda Banos\nGaddiel Roldan Lara\nSergio Corona',
    version='0.0.0',
    ...
    description='A Python-based ROS 2 package that integrates the Nav2 autonomus mapping and navigation with the PuzzleBot simulation.',
